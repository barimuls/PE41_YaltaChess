...
- Le serveur vient d'être lancé
- Pour accéder à votre instance, ouvrer votre navigateur internet
- Aller sur le site : http://127.0.0.1:5000/
- Pour accéder avec un autre ordinateur, utiliser la seconde IP donnée dans votre console Python
