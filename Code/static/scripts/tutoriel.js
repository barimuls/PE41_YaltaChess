...
function goToTutoriel(mode) {
    ...
    if (tutorielId == "tutoriel_cavalier") {
        ...
        document.getElementById("tutoriel_apres").style.display = "inline-block";
        document.getElementById("tutoriel_avant").style.display = "inline-block";
    }
    // 1. Créer une nouvelle partie côté serveur
    fetch(`/change_tutoriel/${gameId}`, {
        method: "POST",
